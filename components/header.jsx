      ...
      <div className="mx-auto py-4 px-4 md:px-0">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <Link href="https://www.linkedin.com/company/all-works-ingenieria">
              <Button className="hidden md:inline-flex rounded-md cursor-pointer ">
                <Linkedin/>
              </Button>
            </Link>
            <Link className="flex mr-8" href="https://wa.me/541124611212?text=Hola!%20Vengo%20de%20su%20p%C3%A1gina%20web%20y%20quiero%20saber%20m%C3%A1s%20sobre...">
              <Button className="hidden md:inline-flex rounded-md cursor-pointer">
